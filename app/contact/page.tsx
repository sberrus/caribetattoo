...
const page = () => {
    return (
        <div className="max-w-screen-lg mx-auto p-5 pt-24">
            <div className="grid grid-cols-1 md:grid-cols-12 border border-yellow-950">
                <div className="bg-dark md:col-span-4 p-10 text-white">
                    <h3 className={`${gfont.className} text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight`}>
                        ¿Listo para dejar tu{" "}
                        <span className="text-primary">marca</span> {" "}en el mapa?
                    </h3>
                    <p className="mt-4 leading-7 text-gray-200">
                        Estamos listos para escuchar tus ideas y transformarlas en arte que llevarás contigo para siempre. Escríbenos, hablemos de tu diseño y hagamos que esta historia quede grabada en tu piel. ¡Contáctanos hoy!
                    </p>

                    <div className="flex items-center mt-5">
                        <svg className="h-6 mr-2 text-primary" fill="currentColor" version="1.1"
                    ...
                    <div className="flex items-center mt-5">
                        <svg className="h-6 mr-2 text-primary" fill="currentColor" version="1.1" id="Capa_1"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                        ...
                        <span className="text-sm">+34 624 192 210</span>
                    </div>
                </div>
                <form className="md:col-span-8 p-10">
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            <label className="block uppercase tracking-wide text-yellow-400 text-xs font-bold mb-2"
                                htmlFor="grid-first-name">
                                Nombre
                            </label>
                            <input
                                className="appearance-none block w-full bg-gray-200 text-yellow-400 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            <input
                                className="appearance-none block w-full bg-gray-200 text-yellow-400 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <input
                                className="appearance-none block w-full bg-gray-200 text-yellow-400 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <textarea rows={10}
                                className="appearance-none block w-full bg-gray-200 text-yellow-400 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"></textarea>
                        </div>
