...
const TestimonialsSection = () => {
    ...
    const handleClickNextButton: React.MouseEventHandler = (e) => {
        ...
        if (currentTestimonial === testimonial.length - 1) {
            console.log(currentTestimonial, testimonial.length - 1);
            ...
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:-mx-6 lg:flex lg:items-center transition-all">
                    ...
                    <div className="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
                        ...
                        <h3 className="mt-6 text-lg font-medium text-blue-500">{testimonial[currentTestimonial].es.testimonialFullName}</h3>
